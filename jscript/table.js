...
var Table = (function(){
	...
	table.filter = function(o,filters,args) {
		...
		if (!filters) {
			...
			if (filters.nodeName=="INPUT" && filters.type=="text") {
				filters={ 'filter':"/^"+filters.value+"/i" };
			}
	...
	*/
	table.scrape = function(o,args) {
		...
		if (totalrows != unfilteredrowcount && typeof(doPostFilter)!="undefined")
			doPostFilter();
		else if (totalrows == unfilteredrowcount && typeof(doPostFilter)!="undefined")
			cleanPosData();
